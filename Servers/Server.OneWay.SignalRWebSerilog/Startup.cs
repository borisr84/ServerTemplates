...
using Server.OneWay.SignalRWebSerilog.Hubs;
using Server.OneWay.SignalRWebSerilog.Services;
using System;
...
namespace Server.OneWay.SignalRWebSerilog
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<CalculatorService>().As<ICalculator>().SingleInstance();
        }
    }
}
